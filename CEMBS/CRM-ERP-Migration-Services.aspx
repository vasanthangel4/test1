<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true"
    CodeFile="CRM-ERP-Migration-Services.aspx.cs" Inherits="CRM_ERP_Migration_Services" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="layout_head" runat="Server">
    <title>CRM Migration | ERP Migration</title>
    <meta name="description" content="With the experience that CEM has gained in migration, provides unparalleled expertise to create a viable strategy that fits your particular business need. CEM offers services in the areas of Migration. The Migration services include migration of a customer from other ERP into the Microsoft Dynamics. We have migration tools for migration from other ERP to Microsoft Dynamics.Our migration service includes: 1.Full Data Migration Services 2.On-going support and maintenance 3.Pre-migration business planning 4.Business Process Analysis and Re-engineering 5.Software evaluation and implementation 6.raining on using and maintaining Microsoft Dynamics" />
    <meta name="keywords" content="Dynamics CRM Migration, data migration, software migration, crm migration, erp migration , dynamics crm migration, nav migration, ax migration, axapta migration" />
    <meta name="robots" content="index, follow" />
    <link href="Styles/OthersPages/MS_Dyn_ERP.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript">
        $(document).ready(function () {
            $('#m_services').addClass('bluebg');
            //location.href = location.href + '#migration';
