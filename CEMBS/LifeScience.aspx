<%@ Page Title="" Language="C#" MasterPageFile="Layout.master" AutoEventWireup="true" CodeFile="LifeScience.aspx.cs" Inherits="LifeScience" %>
...
<title>Microsoft Dynamics ERP Life Sciences | Dynamics CRM for the Life Sciences </title>
<meta name="description" content="Microsoft Dynamics ERP and CRM solutions, along with our partners’ deep vertical expertise, enable life sciences organizations to quickly deploy an integrated set of leading-edge business applications inexpensively, and without complicated customizations, to help address these challenges."/>
<meta name="keywords" content="Microsoft Dynamics ERP Life Sciences, Dynamics CRM for the Life Sciences"/>
<meta name="robots" content="index, follow"/>
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".tab_content:#tab14").show(); //Show first tab content
    ...
    <div class="content_div">
        <div class="container">
            <ul class="tabs">
                ...
                <li class="active"><a href="#tab14">Life sciences</a></li>
