...
public partial class Microsoft_Dynamic_r3_in_doha_index : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Designationl.Text == null)
        {
            sclass.Designation = string.Empty;
        }
        else
        {
            sclass.Designation = Designationl.Text;
        }
        ...
        sclass.ToEmail = "srinivasan.b@cembs.com";
        sclass.CCEmail = "Arokia@cembs.com";
        requestdate = System.DateTime.Now;
        formname = "Microsoft Dynamic R3 in Doha";
    }
    ...
    {
        string Automessage = "<span style='font-family:arial;'> Dear " + sclass.name + ".<br/><br/>Thank you for your interest in Microsoft Dynamics R3 in Doha. A representative will contact you shortly. If you want to reach us immediately, please don’t hesitate to call or email me.<br/><br/>Best regards<br/>Deepa.c<br/>Product Specialist <br/>CEM Business Solutions <br/><a href='mailto:deepa.c@cembs.com'>deepa.c@cembs.com</a> <br/>(p) +971 4 3911683</span>";
