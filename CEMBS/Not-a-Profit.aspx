<%@ Page Title="" Language="C#" MasterPageFile="Layout.master" AutoEventWireup="true" CodeFile="Not-a-Profit.aspx.cs" Inherits="Not_a_Profit" %>
...
<title> Microsoft dynamics CRM for nonprofit organizations | Microsoft Dynamics for not-for-profit organizations </title>
<meta name="description" content="Microsoft Dynamics offers powerful non-profit organizations management solutions focused on the common needs of non-profit organizations"/>
<meta name="keywords" content="Microsoft dynamics CRM for nonprofit organizations | Microsoft Dynamics for not-for-profit organizations"/>
<meta name="robots" content="index, follow"/>
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".tab_content:#tab23").show(); //Show first tab content
    ...
    <div class="content_div">
        <div class="container">
            <ul class="tabs">
                ...
                <li class="active"><a href="#tab23">Non-profit Organizations</a></li>
