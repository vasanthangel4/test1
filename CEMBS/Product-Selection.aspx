<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true"
    CodeFile="Product-Selection.aspx.cs" Inherits="Product_Selection" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="layout_head" runat="Server">
    ...
    <meta name="keywords" content="product selection, product configuration, product selection process, product selection guide" />
