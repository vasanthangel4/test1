...
var fm = (function () {
	...
	function triggerAction(event) {
		...
		if ($("#feedback_trigger").hasClass("feedback_trigger_closed")) {
			if (supportsTransitions === true) {
				...
				$("#feedback_trigger").addClass("feedback_trigger_opened");
			...
			$("#feedback_trigger").removeClass("feedback_trigger_opened");
	...
	function validateFeedbackForm() {
		if ((fm_options.name_required === true && $("#feedback_name").val() === "") ||
				...
				(fm_options.phone_required === true && $("#feedback_phone").val() === "") ||
	...
	function appendFeedbackToBody() {
		var form_html = "",
			...
			phone_required = fm_options.phone_required ? "required" : "",
			...
			phone_asterisk  = fm_options.phone_required && fm_options.show_asterisk_for_required ? "<span class=\"required_asterisk\">*</span>" : "",
		...
		if (fm_options.show_phone === true) {
			phone_html = '<li>	<label for="feedback_phone">' + fm_options.phone_label + '</label> ' + phone_asterisk + ' <input type="text" id="feedback_phone" ' + phone_required + ' placeholder="' + fm_options.phone_placeholder + '"></input> </li>';
			phone_feedback_content_class = " phone_present";
		}
		...
		$('body').append('<div id="feedback_content" class="feedback_content_closed ' + fm_options.position + email_feedback_content_class + phone_feedback_content_class + radio_button_list_class + jQueryUIClasses2 + fm_class + jquery_class + bootstrap_class + bootstrap_hero_unit + '">'
	...
	function init(options) {
		...
		var default_options = {
			feedback_url : "AjaxService.svc/AjaxMail_Contact",
			position : "left-top",
			jQueryUI : false,
			bootstrap : false,
			show_email : true,
			...
			submit_label : "Submit",
			title_label : "Please fill in the form below",
