...
base.init();};$.omr.totemticker.defaultOptions={message:'Ticker Loaded',next:null,previous:null,stop:null,start:null,row_height:'100px',speed:400,interval:25000,max_items:null,};$.fn.totemticker=function(options){return this.each(function(){(new $.omr.totemticker(this,options));});};})(jQuery);