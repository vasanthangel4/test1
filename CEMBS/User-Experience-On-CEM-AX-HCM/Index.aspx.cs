...
public partial class User_Experience_On_CEM_AX_HCM_Index : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        formname = "User-Experience-On-CEM-AX-HCM Landing Page";
    }
    ...
    protected void sendmailfill()
    {
        ...
        //client.GetDataAsync("User-Experience-On-CEM-AX-HCM Landing Page", fill_NameTextBox.Text, fill_CompanyTextBox.Text, fill_MailTextBox.Text, fill_PhoneTextBox.Text, website);
    ...
    protected void subscribe_btn_Click(object sender, EventArgs e)
    {
        ...
        //client.GetDataAsync("User-Experience-On-CEM-AX-HCM Landing Page", sclass.name, sclass.Company, sclass.email, sclass.phone, website);
