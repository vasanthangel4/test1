<%@ Page Title="" Language="C#" MasterPageFile="Layout.master" AutoEventWireup="true"
    CodeFile="About-CEM.aspx.cs" Inherits="About_CEM" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="layout_head" runat="Server">
    <title>About CEMBS | ERP and CRM solutions </title>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#m_about').addClass('bluebg');
            //Default Action
            //$(".tab_content").hide(); //Hide all content
            //$("ul.tabs li:nth-child(2)").addClass("active").show(); //Activate first tab
            //$(".tab_content:#about").show(); //Show first tab content
