...
public partial class Business_enhancements_through_ax_hcm_Index : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sclass.ToEmail = "arokia@cembs.com";
        sclass.CCEmail = "srinivasan.b@cembs.com";
        requestdate = System.DateTime.Now;
        formname = "Business-enhancements-through-ax-hcm Landing Page";
    }
    ...
    protected void sendmailfill()
    {
        ...
        client.GetDataAsync("Business-enhancements-through-ax-hcm Landing Page", fill_NameTextBox.Text, fill_CompanyTextBox.Text, fill_MailTextBox.Text, fill_PhoneTextBox.Text, website);
        Response.Redirect("http://www.cembs.com");
    }
    protected void subscribe_btn_Click(object sender, EventArgs e)
    {
        string Automessage = "Dear " + sclass.name + ".<br/><br/>Thank you for your interest in CEM AX HCM. A representative will contact you shortly. If you want to reach us immediately, please don’t hesitate to call or email me.<br/><br/>Best regards<br/>Michael Vana <br/>Marketing Director <br/>CEM Business Solutions <br/>michael.vana@cembs.com <br/>(201) 391-5345 ";
        ...
        client.GetDataAsync("Business-enhancements-through-ax-hcm Landing Page", sclass.name, sclass.Company, sclass.email, sclass.phone, website);
