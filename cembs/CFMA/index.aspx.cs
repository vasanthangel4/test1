...
public partial class CFMA_index : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        formname = "CFMA_workshop_landing_page";
    }
    ...
    {
        string Automessage = "Dear " + sclass.name + ".<br/><br/>Thank you for your interest in CEM CFMA Workshop Landing Page. A representative will contact you shortly. If you want to reach us immediately, please don’t hesitate to call or email me.<br/><br/>Best regards<br/>Michael Vana <br/>Marketing Director <br/>CEM Business Solutions <br/>michael.vana@cembs.com <br/>(201) 391-5345 ";
