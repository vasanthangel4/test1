<%@ Page Title="" Language="C#" MasterPageFile="~/LandingPage.master" AutoEventWireup="true" Async="true"
    CodeFile="Construct-ERP-MENA.aspx.cs" Inherits="Construct_ERP_MENA" %>
...
<div id="boxes">
    ...
    <div class="content_div">
        ...
        <div>
            ...
            <div style="float: left; width: 330px; margin: 45px 0px 0px 0px; min-height: 860px;">
                <div style="color: #ffffff; text-align: center; text-align: center;">
                    <a style="margin-top: 0px; display: block;" target="blank" href="http://www.cembs.com/industry-summit-dubai">
                <img alt="register" src="Images/ConstructFormMENA_bg.png" /></a>
                    <%--<h4>
                        Get a demo &amp;
                        <br />
                        Learn more about CEM AX Construct</h4>--%>
                    <div style="color: #000; text-align: center; margin: 5px 0 0 0;display:none;">
                ...
                <div style="color: #ffffff;display:none; text-align: center; position: relative; top: 125px;">
                    <a href="mailto:info@cembs.com" style="color: #fff !important; font-weight:bold; text-decoration:none; text-align: center;">Email: info@cembs.com
                    </a>
                </div>
                <div style="color: #ffffff; display:none;text-align: center; margin: 128px 0 0 0">
                    <div style="color: #000; text-align: center;">
                        <a href="Contactus.aspx">
                            <img src="Images/map_construct_dubai.png" alt="contact" width="296" height="237" />
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div style="clear:both;padding-bottom:20px; padding-left:10px;">See the evidence! 
		<a href="http://www.microsoft.com/casestudies/Microsoft-Dynamics-AX-2012/Granite-Construction-Company/International-Construction-Powered-by-Microsoft-ERP/710000002980" target="_blank">Case study</a> 
		showcases the solution provided by CEM for  Granite Construction Company, Abu Dhabi. 
</div>
