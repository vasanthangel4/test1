<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Debug="true"
    Inherits="Default" %>
...
<body class="size-980">
    <div class="wrap">
      ...
      <form runat="server"><menu:extended ID="extended" runat="server" /></form>
      ...
      <!-- Banner Section -->
    	...
    	<div class="line">
        	...
        	<div class="news-ticker-sec">
            	<div class="tic_lef">OUR Accomplishments</div>
                <div class="tic_rig">
                <ul id="ticker01">
    ...
    <!-- eccetera --></div>
        ...
        <div class="flip_section">
           	<div class="tab_mcon">
        		...
        		<div class="tab_sec">
					<img src="images/v3/flip-01.jpg" width="189" height="161" />
					<div class="con">With increased competition adding intensity to the growing economy,companies in the construction industry are planning to complete</div>
             ...
             <div class="tab_mcon">
            	<h1>CEM AX HCM</h1>
        		<div class="tab_sec">
					<img src="images/v3/flip-02.jpg" width="189" height="161" />
					<div class="con">Businesses with modern thoughts operate in highly competitive and complex environments. Executing new business strategies</div>
             ...
             <div class="tab_mcon">
        		...
        		<div class="tab_sec">
					<img src="images/v3/flip-04.jpg" width="189" height="161" />
					<div class="con">It is the responsibility of each and every organization to manage and motivate their employees by providing them better wages</div>
             ...
             <div class="tab_mcon">
        		...
        		<div class="tab_sec">
					<img src="images/v3/flip-05.jpg" width="189" height="161" />
					<div class="con">Triumphant management professionals in construction industry have the reputation of delivering projects on time and on budget.</div>
             ...
             <div class="tab_mcon_la">
            	<h1>CEM AX Retail</h1>
        		<div class="tab_sec">
					<img src="images/v3/flip-03.jpg" width="189" height="161" />
					<div class="con">The present day retail environment offers ever expanding opportunity while also posing unprecedented challenges.</div>
...
How to squeeze more life out of your AX 2009 solution.</h2>
          ...
          <li><div class="blog_cont">
          <h2>What Existing AEC solutions lack, and How Dynamics AX can help.</h2>
          <div class="blog_cont_s">
            <p>The Facts There is no such thing as the perfect, out-of-the-box, ERP application for the AEC industry, or any industry for that matter. No two businesses are exactly the same and businesses operate in a state of continuous change.</p>
          </div>
          <p class="link_t"><a href="http://www.cembs.com/blog/post/What-Existing-AEC-solutions-lack-and-How-Dynamics-AX-can-help-you.aspx" target="_blank">[Read More]</a></p>
        </div></li>
          <li><div class="blog_cont">
          <h2>Not just a mere component to our web site, but with a real…</h2>
          <div class="blog_cont_s">
            <p>We are excited to be out here talking to you through our newly created blog! CEM, the Centre of Excellence for Management entrenched with a clear focus on Microsoft Dynamics practices. CEM has been servicing organizations with high technology software products for over a decade now.</p>
          </div>
          <p class="link_t"><a href="http://www.cembs.com/blog/post/Not-just-a-mere-component-to-our-web-site-but-with-a-real-meaning-and-difference%E2%80%A6.aspx" target="_blank">[Read More]</a></p>
        </div></li>
          </ul>
...
Forrester's latest assessment of Enterprise Content Management (ECM) vendors paints a picture of a rapidly changing landscape that's being driven both by vendor innovations and user needs.</p>
      ...
      <div id="tab4">
          <div><a href="https://www.youtube.com/watch?v=o7xLbZw2Lpo" target="_blank"><img src="Images/v3/youtube.jpg" alt="youtube" height="238" width="458" /></a></div>   
      </div>
  </div></div>
 <div class="lasttab">
  <ul id="tabs2">
  ...
  <div id="content2">
    ...
    <script src="Scripts/v3/flexslider.min.js"></script>
