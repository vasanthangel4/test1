...
public partial class Payroll_Index : System.Web.UI.Page
{
    ...
    protected void sendmailfill()
    {
        ...
        string Automessage = "Dear " + fill_NameTextBox.Text + ".<br/><br/>Thank you for your interest in CEM AX Payroll. A representative will contact you shortly. If you want to reach us immediately, please don’t hesitate to call or email me.<br/><br/>Best regards<br/>Michael Vana <br/>Marketing Director <br/>CEM Business Solutions <br/>michael.vana@cembs.com <br/>(201) 391-5345 ";
        client1.mailquotenewAsync(fill_NameTextBox.Text, sclass.ToEmail, sclass.CCEmail, fill_CompanyTextBox.Text, fill_PhoneTextBox.Text, "", "", "Payroll Landing Page", MessageTextBox.Text, requestdate, formname);
        client1.AutomessageAsync(fill_MailTextBox.Text, fill_NameTextBox.Text, "CEM Business Solutions", Automessage);
        client1.InsertQuoteAsync(fill_NameTextBox.Text, "", fill_CompanyTextBox.Text, fill_PhoneTextBox.Text, "", fill_MailTextBox.Text, "Payroll Landing Page", requestdate, formname);
        client.GetDataAsync("Payroll Landing Page", fill_NameTextBox.Text, fill_CompanyTextBox.Text, fill_MailTextBox.Text, fill_PhoneTextBox.Text, website);
        Response.Redirect("http://www.cembs.com/HCM/Index.aspx?visitor");
    }
    protected void subscribe_btn_Click(object sender, EventArgs e)
    {
        string Automessage = "Dear " + sclass.name + ".<br/><br/>Thank you for your interest in CEM AX Payroll. A representative will contact you shortly. If you want to reach us immediately, please don’t hesitate to call or email me.<br/><br/>Best regards<br/>Michael Vana <br/>Marketing Director <br/>CEM Business Solutions <br/>michael.vana@cembs.com <br/>(201) 391-5345 ";
        ...
        client.GetDataAsync("Payroll Landing Page", sclass.name, sclass.Company, sclass.email, sclass.phone, website);
